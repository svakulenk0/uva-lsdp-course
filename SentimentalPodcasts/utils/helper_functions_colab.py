...
def get_paths_for_en_episodes(subset_number):
    ...
    """
    metadata_df = pd.read_csv("/content/drive/MyDrive/DA_project/podcast_data_no_audio/metadata/metadata.tsv",sep='\t')
    path1 = '/content/drive/MyDrive/DA_project/podcast_data_no_audio/podcasts-transcripts/' + str(subset_number)

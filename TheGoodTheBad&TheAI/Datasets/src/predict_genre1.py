...
from Datasets.src.Vectorizer1 import Vectorizer
from Datasets.src.Model1 import Model

from keras.models import model_from_json
import tensorflow as tf

def load_keras_model(model_path='Datasets/model/'):
    with open(model_path +"model1.json", 'r') as json_file:
        loaded_model_json = json_file.read()

    loaded_model = tf.keras.models.model_from_json(loaded_model_json)
    # load weights into new model
    loaded_model.load_weights(model_path+"model1.h5")
    return loaded_model
